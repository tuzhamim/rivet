...
echo '<div class="rivet-testimonial-3__item pasty-bg">';
    echo '<div class="rivet-testimonial-3__rating text-center">';
    ...
    echo '<div class="rivet-testimonial-3__avater rivet-d-flex rivet-align-items-center rivet-justify-content-center">';
        ...
        echo '</div>';
    echo '</div>';
    $this->logo_print( $testimonial, true, 'rivet-testimonial-3__shape els-3', false );
echo '</div>';