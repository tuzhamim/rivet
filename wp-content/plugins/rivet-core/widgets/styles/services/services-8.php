...
echo '<div class="rivet-services-8__item">';
    if( !empty( $services_image_url ) ) : 
    echo '<div class="rivet-services-8__thumb">';
        echo '<img src="' . esc_url( $services_image_url ) . '" alt="' . Control_Media::get_image_alt( $service['services_thumb'] ) . '">';
    echo '</div>';
    endif;
    echo '<div class="rivet-services-8__text">';
        $this->icon_print( $service, true, 'rivet-services-8__icon' );
        echo '<div class="rivet-services-8__content">';
            echo '<h6 class="rivet-services-8__title">';
