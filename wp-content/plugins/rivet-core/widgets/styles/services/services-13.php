...
echo '<div class="rivet-services-16__item">';
    if( !empty( $services_image_url ) ) : 
    echo '<div class="rivet-services-16__bg">';
        echo '<img src="' . esc_url( $services_image_url ) . '" alt="' . Control_Media::get_image_alt( $service['services_thumb'] ) . '">';
    echo '</div>';
    endif;
    $this->icon_print( $service, true, 'rivet-services-16__icon' );
    echo '<div class="rivet-services-16__content">';
        echo '<h4 class="rivet-services-16__title">';
        ...
        echo '<div class="rivet-services-16__btn">';
